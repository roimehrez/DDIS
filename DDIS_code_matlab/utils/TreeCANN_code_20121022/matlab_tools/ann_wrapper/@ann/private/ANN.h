...
typedef /* double */  float ANNcoord;				// coordinate data type // BAGON modified
typedef double	ANNdist;				// distance data type

/* bagon added to support matlab wrapper */
#define mxCOORD_CLASS   /* mxDOUBLE_CLASS */ mxSINGLE_CLASS
#define mxDIST_CLASS    mxDOUBLE_CLASS
...
/* bagon added to support matlab wrapper */
#define mxIDX_CLASS     mxINT32_CLASS
...
#else
	const int	 ANNcoordPrec	= 6 /* 15; */	// default precision
#endif
